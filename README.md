...
| ------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- |
| [1. Two Sum][1]                                              | [Rust](./Rust/src/two_sum.rs), [C#](./CSharp/TwoSum/Solutions.cs), [Go](./Golang/two_sum/1.go), [TypeScript](./TypeScript/two_sum/1.ts), [C++](./C++/src/two_sum.cpp) | Easy       |
...
| [13. Roman to Integer][13]                                   | [Rust](./Rust/src/roman2int.rs), [C#](./CSharp/RomanToInteger/Solutions.cs), [Go](./Golang/roman_to_integer/13.go)                                                    | Easy       |
