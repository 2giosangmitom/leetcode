...
| ------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- |
| [1. Two Sum][1]                                              | [Rust](./Rust/src/two_sum.rs), [C#](./CSharp/Solutions/TwoSum.cs), [Go](./Golang/two_sum/1.go), [TypeScript](./TypeScript/two_sum/1.ts), [Java](./Java/lib/src/main/java/org/leetcode/TwoSum.java) | Easy       |
...
| [704. Binary Search][704]                                    | [Rust](./Rust/src/binary_search.rs), [Java](./Java/lib/src/main/java/org/leetcode/BinarySearch.java)                                                                         | Easy       |
