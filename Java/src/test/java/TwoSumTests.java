...
class TwoSumTests {
  ...
  void test_1() {
    ...
    int[] result2 = TwoSum.twoSum2(new int[] {2, 7, 11, 15}, 9);
  ...
  void test_2() {
    ...
    int[] result2 = TwoSum.twoSum2(new int[] {3, 2, 4}, 6);
  ...
  void test_3() {
    ...
    int[] result2 = TwoSum.twoSum2(new int[] {3, 3}, 6);
    assertArrayEquals(new int[] {0, 1}, result);
    assertArrayEquals(new int[] {0, 1}, result2);
  }
  ...
  void test_4() {
    ...
    int[] result2 = TwoSum.twoSum2(new int[] {2, 3, 4, 1, 25, 8}, 30);
